...
- **顶部工具栏**：画笔 / 橡皮擦、颜色、粗细、撤销 / 重做、清空、保存，
  **素描模板选择器**，以及三个可选开关：手势控制、显示摄像头、显示骨架。
